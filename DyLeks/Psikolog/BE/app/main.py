...
from app.api.v1 import psychologist as psychologist_api
...
from app.models import user, child_profile, exercise, screening_session, qr_token, psychologist
...
app.include_router(psychologist_api.router, prefix="/api/v1/psychologist", tags=["Medical Psychologist System"], dependencies=[Depends(general_rate_limiter.check_rate_limit)])
