...
from app.api.v1 import screening, chat, learning, auth, sync, speech
...
app.include_router(speech.router, prefix="/api/v1/speech", tags=["Phonological Speech Mode"], dependencies=[Depends(general_rate_limiter.check_rate_limit)])
