...
def test_upload_screening_invalid_base64():
    ...
    # Karena gagal baca gambar, TrOCR akan mengembalikan skor 50 dan errors "Mesin analisis tidak dapat membaca gambar..."
    assert "Mesin analisis tidak dapat membaca gambar" in data["detected_errors"][0]
